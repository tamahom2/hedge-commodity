...
public abstract class Strategy {
	...
	protected double volatility = 0.0;
	...
	public Strategy(double putPercent, double callPercent, double strike, double expiration, double volatility) {
		this.putPercent = putPercent;
		this.callPercent = callPercent;
    ...
    public abstract double[] simulateOneVolume(double S0, double r, int duration, Scenario scenario, double hedgedVolume, List<OptionData> forwardCurve, double vol);
