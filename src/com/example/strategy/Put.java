...
public class Put extends Strategy {
	...
	public Put(double putPercent, double strike, double expiry, double volatility) {
		super(putPercent, 0, strike, expiry, volatility);
	}
	...
	public void backtest(double EPRMS, double pdd, double spread, double r, double vol, double[] maturities,
		...
		System.out.println(EPRMS + " " + pdd + " " + r + " " + vol);
